intellisense.annotate(jQuery, {
  'ajax': function() {
    ...
    ///   <param name="settings" type="PlainObject">A set of key/value pairs that configure the Ajax mathTask. All settings are optional. A default can be set for any option with $.ajaxSetup(). See jQuery.ajax( settings ) below for a complete list of all settings.</param>
    ///   <returns type="jqXHR" />
    /// </signature>
    /// <signature>
    ///   <summary>Perform an asynchronous HTTP (Ajax) mathTask.</summary>
    ///   <param name="settings" type="PlainObject">A set of key/value pairs that configure the Ajax mathTask. All settings are optional. A default can be set for any option with $.ajaxSetup().</param>
    ///   <returns type="jqXHR" />
    /// </signature>
  },
  ...
  'ajaxSetup': function() {
    ...
    ///   <param name="options" type="PlainObject">A set of key/value pairs that configure the default Ajax mathTask. All options are optional.</param>
    /// </signature>
  },
  ...
  'get': function() {
    ...
    ///   <param name="url" type="String">A string containing the URL to which the mathTask is sent.</param>
    ///   <param name="data" type="">A plain object or string that is sent to the server with the mathTask.</param>
  ...
  'getJSON': function() {
    ...
    ///   <param name="url" type="String">A string containing the URL to which the mathTask is sent.</param>
    ///   <param name="data" type="PlainObject">A plain object or string that is sent to the server with the mathTask.</param>
    ///   <param name="success(data, textStatus, jqXHR)" type="Function">A callback function that is executed if the mathTask succeeds.</param>
    ///   <returns type="jqXHR" />
    /// </signature>
  },
  ...
  'post': function() {
    ...
    ///   <param name="url" type="String">A string containing the URL to which the mathTask is sent.</param>
    ///   <param name="data" type="">A plain object or string that is sent to the server with the mathTask.</param>
    ///   <param name="success(data, textStatus, jqXHR)" type="Function">A callback function that is executed if the mathTask succeeds. Required if dataType is provided, but can be null in that case.</param>
